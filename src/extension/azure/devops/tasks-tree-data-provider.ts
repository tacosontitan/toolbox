...
export class TasksTreeDataProvider implements vscode.TreeDataProvider<WorkItemTreeItem | TaskTreeItem | PlaceholderTreeItem | StateGroupTreeItem>, vscode.TreeDragAndDropController<WorkItemTreeItem | TaskTreeItem | PlaceholderTreeItem | StateGroupTreeItem> {
    ...
    readonly dropMimeTypes = ['application/vnd.code.tree.taskstreeview'];
    readonly dragMimeTypes = ['application/vnd.code.tree.taskstreeview'];
